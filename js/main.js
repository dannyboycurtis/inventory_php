...
function returnToQuery( query, type )
{
	...
	if ( type == "tag_num" || type == "serial" || type == "makemodel" || type == "hostname" || type == "ip" || type == "mac" || type == "location" || type == "purchasedate" || type == "purchasedby" || query == "_computers" || query == "_labs" || query == "_printers" )
